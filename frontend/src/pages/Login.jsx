        ...
        <div className="grid grid-cols-2 max-h-screen">
            <div className="flex flex-col py-12">
                ...
                <div className="my-1 mx-auto items-center justify-center">
                    <p className="text-lg text-white opacity-40">Login to your account</p>
                </div>
                <div className="mt-2 p-4 px-14">
                    <form onSubmit={handleSubmit}>
                        <div className="flex flex-col mb-4">
                            ...
                            <div>
                            <input type={showPassword ? "text" : "password"} name="password" className="rounded-md p-2 my-0.5 border-1 border-gray-600 text-white" placeholder="******" value={formdata.password} onChange={(e)=>(setformdata({...formdata,password:e.target.value}))}/>
                            </div>
                            <div className="p-2">
                            ...
                            <button type="submit" className="rounded-md bg-amber-600 text-black font-bold cursor-pointer py-2 px-auto" disabled={isLoggingIn}>Log In</button>
                            <br/>
                            <div className="mx-auto justify-center">
                            <p className="text-white text-sm font-medium">New on ChatPro? <Link to="/signup" className="link link-primary">Sign Up</Link></p>
                            </div>
